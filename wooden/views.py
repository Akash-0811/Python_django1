...
from wooden.forms import CreateUserForm 
...
def register(request):	
	...
	if request.method == 'POST':
		...
		if form.is_valid():
			...
			return redirect('wooden:login_reg')
...
def logoutuser(request):
	logout(request)
	# return redirect('wooden:login_reg')
	return redirect('wooden:home')


@login_required(login_url = 'wooden:login_reg')
def home(request):
	return render (request,"signin/home.html", context = {})
